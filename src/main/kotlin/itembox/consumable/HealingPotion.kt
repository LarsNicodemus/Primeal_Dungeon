...
class HealingPotion(name : String = "Healing Potion") : ConsumableItem(name){
    override fun use(villain: Villain){
        ...
        println()
        threadsleep(4)
        printlnWithDelay("${villain.name} drinks a healing potion and restores ${roundDouble(villain.maxHP/2)} health points. Actual health points: ${roundDouble(villain.hp)} ",15)
        threadsleep(4)
        println()
    }
